        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <StatCard label="Total Test Cases" value={stats.total} icon={FileCheck2} />
                    <StatCard label="Unassigned" value={stats.unassigned} icon={UserX} />
                    <StatCard label="Created (7 days)" value={stats.createdLast7Days} icon={CalendarPlus} />
                    <StatCard label="Statuses in Use" value={stats.statusesInUse} icon={ListTodo} />
                </div>
